...
import { Building2, Mail, Lock, Building, Globe, AlertCircle } from 'lucide-react';
...
export const Signup = ({ onSuccess, onToggleLogin }: SignupProps) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const data = await api.auth.signup(email, password, tenantName, tenantDomain);
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-slate-100 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md p-8">
        ...
        <div className="mb-6">
          ...
          <p className="text-slate-600 text-center mt-2">Get started with your CRM</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <p className="mt-1 text-xs text-slate-500">Unique identifier for your organization</p>
          </div>
